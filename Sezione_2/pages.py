...
def get_beldat(page_obj):
    ...
    bin_labels = [str(farm_dat["alt" + str(b)].iloc[0]) for b in range(1,9) if str(farm_dat["alt" + str(b)].iloc[0]) != "nan"]
    alt_labels = [str(farm_dat["alt" + str(b)].iloc[0]) for b in range(1,9) if str(farm_dat["alt" + str(b)].iloc[0]) != "nan"]
...
class Page_17_Esempio2(Page):
    pass
class Page_18_Esempio3(Page):
    pass
class Page_18_Esempio3a(Page):
    pass
class Page_19(Page):
...
class Page_20(Page):
    ...
    def before_next_page(self):
        choice = [getattr(self.player, "bin" + str(b)) for b in range(1, 9)]
