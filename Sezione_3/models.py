...
class Subsession(BaseSubsession):
    def creating_session(self):
        ...
        self.session.vars['HL_row2'] = random.randint(11,15)
        self.session.vars['HL_row3'] = random.randint(17,25)
        self.session.vars['HL_row4'] = random.randint(27,35)
...
class Player(BasePlayer):
    ...
    HL_2 = models.IntegerField(choices=[[11, ''],
                                        [12, ''],
                                        [13, ''],
                                        [14, ''],
                                        [15, ''],
                                        [16, '']], widget=widgets.RadioSelect, blank=True)
    HL_3 = models.IntegerField(choices=[[17, ''],
                                        [18, ''],
                                        [19, ''],
                                        [20, ''],
                                        [21, ''],
    ...
    HL_4 = models.IntegerField(choices=[[27, ''],
                                        [28, ''],
                                        [29, ''],
                                        [30, ''],
                                        [31, ''],
    ...
    def set_payoff_HL(self):
        ...
        if self.session.vars['HL_random'] == 1:
            ...
            if self.participant.vars['choices'][1] <= self.participant.vars['w_row']:
                self.participant.vars['payoff_HL'] = self.participant.vars['final_fix'][self.participant.vars['w_row']-2]
            else:
                self.participant.vars['payoff_HL'] = Constants.fix2[0]
        elif self.session.vars['HL_random'] == 3:
            if self.participant.vars['choices'][2] <= self.participant.vars['w_row']:
                self.participant.vars['payoff_HL'] = self.participant.vars['final_fix'][self.participant.vars['w_row']-3]
            else:
                self.participant.vars['payoff_HL'] = Constants.fix2[0]
        elif self.session.vars['HL_random'] == 4:
            if self.participant.vars['choices'][3] <= self.participant.vars['w_row']:
                self.participant.vars['payoff_HL'] = self.participant.vars['final_fix'][self.participant.vars['w_row']-4]
            else:
                self.participant.vars['payoff_HL'] = Constants.fix2[0]
