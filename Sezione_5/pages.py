...
def get_beldat_new(page_obj):
    ...
    nbin_labels = [str(farm_dat_new["alt" + str(b)].iloc[0]) for b in range(1,9) if str(farm_dat_new["alt" + str(b)].iloc[0]) != "nan"]
    alt_labels = [str(farm_dat_new["alt" + str(b)].iloc[0]) for b in range(1,9) if str(farm_dat_new["alt" + str(b)].iloc[0]) != "nan"]
