...
class Subsession(BaseSubsession):
    def creating_session(self):
        ...
        self.session.vars['rHL_row2'] = random.randint(11,15)
        self.session.vars['rHL_row3'] = random.randint(17,25)
        self.session.vars['rHL_row4'] = random.randint(27,35)
...
class Player(BasePlayer):
    ...
    rHL_1 = models.IntegerField(choices=[[1, ''],
                                        ...
                                        [8, ''],
                                        [9, ''],
                                        [10, '']],widget=widgets.RadioSelect ,blank=True)
    rHL_2 = models.IntegerField(choices=[[11, ''],
                                        [12, ''],
                                        [13, ''],
                                        [14, ''],
                                        [15, ''],
                                        [16, '']], widget=widgets.RadioSelect, blank=True)
    rHL_3 = models.IntegerField(choices=[[17, ''],
                                        [18, ''],
                                        [19, ''],
                                        [20, ''],
                                        [21, ''],
                                        ...
                                        [24, ''],
                                        [25, ''],
                                        [26, '']], widget=widgets.RadioSelect, blank=True)
    rHL_4 = models.IntegerField(choices=[[27, ''],
                                        [28, ''],
                                        [29, ''],
                                        [30, ''],
                                        [31, ''],
                                        ...
                                        [34, ''],
                                        [35, ''],
                                        [36, ''],], widget=widgets.RadioSelect, blank=True)
    ...
    def set_payoff_HLr(self):
        ...
        if self.session.vars['rHL_random'] == 1:
            ...
            if self.participant.vars['rchoices'][1] <= self.participant.vars['w_rrow']:
                self.participant.vars['payoff_HLr'] = self.participant.vars['final_rfix'][self.participant.vars['w_rrow']-2]
            else:
                self.participant.vars['payoff_HLr'] = Constants.rfix2[0]
        elif self.session.vars['rHL_random'] == 3:
            if self.participant.vars['rchoices'][2] <= self.participant.vars['w_rrow']:
                self.participant.vars['payoff_HLr'] = self.participant.vars['final_rfix'][self.participant.vars['w_rrow']-3]
            else:
                self.participant.vars['payoff_HLr'] = Constants.rfix2[0]
        elif self.session.vars['rHL_random'] == 4:
            if self.participant.vars['rchoices'][3] <= self.participant.vars['w_rrow']:
                self.participant.vars['payoff_HLr'] = self.participant.vars['final_rfix'][self.participant.vars['w_rrow']-4]
            else:
                self.participant.vars['payoff_HLr'] = Constants.rfix2[0]
